...
Merchants **do not** need to be listed on DoorDash Marketplace (i.e., the DoorDash app or website) to use this plugin. However, all merchants must sign up for a free [DoorDash Developer account](https://developer.doordash.com/portal?wooCommerce=true) to get API credentials and be approved to launch.
...
1. **Create a Developer portal account:** Log into the DoorDash Developer portal [here](https://developer.doordash.com/portal?wooCommerce=true) and easily generate secure sandbox API credentials for testing.
...
= 1.0.10 =
A bug in the generation process for webhook credentials has been fixed. Please visit the settings and regenerate your webhooks credentials and add the newly generated headers to your DoorDash Developer Portal on the Webhooks screen. This resolves issues with DoorDash Drive receiving 401 errors from WooCommerce.
